...
| :---: | :---: | :--- | :--- | :---: |
| February 2023, World NGO Day Hackathon organised by Code Institute | [SupportNGOs](https://github.com/JoyZadan/emergency-code) | [SupportNGOs](https://support-ngo.herokuapp.com/)   Support NGOs is a platform created during a five day World NGO Day hackathon to help connect people with non-governmental organizations that need support, volunteers, and donations. <br/> **FEATURES** <br/> 1. NGOs database <br/> 2. NGOs database categorized by causes/focus of the NGO's work <br/> 3. Search by name, description of category functionality <br/> 4. Blog application (full CRUD) <br/> 5. User Profile Application (full CRUD) <br/> 6. Newsletter Subscription <br/> 7. Automated Testing <br/> 8. Redirects to individual NGO's website, Charities Aid Foundation, &amp; Volunteering Assoc <br/> **TEAM MEMBERS** <br/> 1. [Joy Zadan](https://github.com/JoyZadan), *scrum master* <br/> 2. [Vasi Pavaloi](https://github.com/Vasi012) <br/> 3. [Erik Ramanauskas](https://github.com/Erikas-Ramanauskas) <br/> 4. [Lee Moran](https://github.com/Lee-moran) | Django, Python, JavaScript and Bootstrap 5, Herok, Amazon S3 | TBD |
